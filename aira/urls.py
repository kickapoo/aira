...
urlpatterns = [
    ...
    path('irrigation-performance-chart/<int:pk_a>/', IrrigationPerformance.as_view(),
         name="irrigation-chart"),
    path('download-irrigation-performance/<int:pk>/', performance_csv,
         name='performance_csv'),
    path('supervised_user/remove/',
